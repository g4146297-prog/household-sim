...
# --- ページ設定 ---
st.set_page_config(
    page_title="将来家計シミュレーション (東京・教育充実版)",
    layout="wide",
...
EDUCATION_COSTS = {
    ...
    '【F】中学受験(私立中高一貫)・文系大': [
        10, 10, 10, 25, 25, 25, 
        # 小学校: 低学年は公立並み、小4から進学塾費用が激増(年50~100万加算)
        35, 35, 35, 80, 100, 140, 
        # 中学校(私立)
        145, 145, 150,
        # 高校(私立)
...
if st.button("AIに診断してもらう"):
    if not user_api_key:
        ...
        try:
            ...
            # アドバイスの構成
            1. 家計の安全性診断 (A~E評価)
            2. 特に資金が厳しくなる時期(中学・高校入学時など)への具体的な備え
